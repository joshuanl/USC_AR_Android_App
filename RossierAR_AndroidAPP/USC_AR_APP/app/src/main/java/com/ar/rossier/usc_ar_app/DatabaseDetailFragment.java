...
import com.ar.rossier.usc_ar_app.dummy.DummyContent;
...
public class DatabaseDetailFragment extends Fragment {
     ...
     */
    private DatabaseContent.DBItem mItem;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments().containsKey(ARG_ITEM_ID)) {
            // Load database list from Firebase
            //mItem = DatabaseContent.DBItem.toString();

            Activity activity = this.getActivity();
            CollapsingToolbarLayout appBarLayout = (CollapsingToolbarLayout) activity.findViewById(R.id.toolbar_layout);
            if (appBarLayout != null) {
                appBarLayout.setTitle(mItem.tag);
            }
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mItem != null) {
            ((TextView) rootView.findViewById(R.id.database_detail)).setText(mItem.toString());
        }
