package com.example.itsfunshine.detailflowexample;
...
import com.example.itsfunshine.detailflowexample.dummy.DummyContent;
...
public class DatabaseDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mItem != null) {
            ((TextView) rootView.findViewById(R.id.database_detail)).setText(mItem.details);
        }
